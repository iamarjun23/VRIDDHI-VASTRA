...
function AdminDashboardContent() {
  ...
  return (
    <div className="space-y-12 animate-in fade-in zoom-in-95 duration-500 pb-16">
      ...
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-8 border-b border-[#E5E0D8] pb-10">
        ...
        <Link
          ...
          className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-[#1A1A1A] text-white text-[10px] font-bold tracking-luxury uppercase rounded-none hover:bg-black transition-all active:scale-[0.98] whitespace-nowrap shadow-xl shadow-black/10"
        >
          Add Piece
        </Link>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8">
        {statCards.map((stat, i) => (
          <div key={i} style={{ animationDelay: `${i * 100}ms`, animationFillMode: 'backwards' }} className="animate-in fade-in slide-in-from-bottom-4 duration-500 bg-white p-8 sm:p-10 border border-[#E5E0D8] shadow-sm hover:shadow-[0_15px_40px_rgba(0,0,0,0.04)] transition-all">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-4 sm:gap-6">
        {/* Trending Widget */}
        <div style={{ animationDelay: `300ms`, animationFillMode: 'backwards' }} className="animate-in fade-in slide-in-from-bottom-4 duration-500 xl:col-span-2 bg-white border border-[#E5E0D8] shadow-sm flex flex-col overflow-hidden">
