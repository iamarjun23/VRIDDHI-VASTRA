...
export default function AdminSidebar() {
  ...
  return (
    <aside className="w-80 h-screen bg-white border-r border-gray-100/50 sticky top-0 flex flex-col shrink-0 shadow-[20px_0_40px_rgba(0,0,0,0.01)]">
      ...
      <div className="p-10 border-t border-gray-100/50 bg-[#F9F8F6]/30">
        <Link
          href="/"
          target="_blank"
