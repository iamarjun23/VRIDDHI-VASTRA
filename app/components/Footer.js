      ...
      <div className="relative z-10 flex flex-row flex-nowrap gap-[clamp(0.25rem,1vw,5rem)] justify-between items-start w-full">
        ...
        <div className="flex flex-row gap-[clamp(0.5rem,1vw,3.5rem)] flex-[1.5] min-w-0 items-start">
          ...
          <Link href="/" className="shrink-0">
            {logo ? (
              ...
              <div className="w-[clamp(80px,15vw,200px)] h-[clamp(80px,15vw,200px)] flex flex-col items-center justify-center shrink-0">
                <span className="text-[clamp(6px,0.8vw,24px)] font-serif leading-none text-center text-brand-gold tracking-[0.2em] uppercase mb-1">
                  VRIDDHI
                </span>
                <div className="w-[clamp(1.5rem,3vw,8rem)] h-[0.5px] bg-brand-gold/40 mb-1"></div>
                <span className="text-[clamp(6px,0.8vw,24px)] font-serif leading-none text-center text-brand-gold tracking-[0.2em] uppercase">
                  VASTRA
                </span>
              </div>
            )}
          ...
          <div className="flex flex-col gap-[clamp(0.4rem,1vw,1.5rem)] pt-1 w-full min-w-0">
            <h2 className="Display H3 font-display text-[clamp(12px,2.5vw,55px)] leading-tight tracking-wider text-white uppercase drop-shadow-md">
              VRIDDHI VASTRA
            </h2>
            <div className="flex flex-col gap-[clamp(0.5rem,1.5vw,2.5rem)]">
              <p className="font-dm-sans text-[clamp(8px,1vw,16px)] leading-relaxed text-white/85 max-w-xl">
              ...
              <div className="flex flex-col gap-[clamp(0.4rem,1vw,1.5rem)] font-dm-sans text-[clamp(8px,1vw,16px)] text-white/85 tracking-wide">
                <div className="flex items-start gap-2">
                  <svg fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" className="w-[clamp(10px,1.2vw,1.25rem)] h-[clamp(10px,1.2vw,1.25rem)] shrink-0 mt-1 opacity-80"><path strokeLinecap="round" strokeLinejoin="round" d="M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" /><path strokeLinecap="round" strokeLinejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1 1 15 0Z" /></svg>
                  <p>random no. bengaluru,<br />india, pin</p>
                </div>
                <div className="flex items-center gap-2">
                  <svg fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" className="w-[clamp(10px,1.2vw,1.25rem)] h-[clamp(10px,1.2vw,1.25rem)] shrink-0 opacity-80"><path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 0 0 2.25-2.25v-1.372c0-.516-.351-.966-.864-1.048l-3.413-.541c-.49-.078-.984.13-1.31.54l-1.93 2.41a15.157 15.157 0 0 1-5.748-5.748l2.409-1.93c.41-.326.618-.82.54-1.311l-.54-3.413a1.125 1.125 0 0 0-1.048-.864H4.5a2.25 2.25 0 0 0-2.25 2.25Z" /></svg>
                  <p>+91-XXXXX-XXXXX</p>
                </div>
                <div className="flex items-center gap-2">
                  <svg fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" className="w-[clamp(10px,1.2vw,1.25rem)] h-[clamp(10px,1.2vw,1.25rem)] shrink-0 opacity-80"><path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25h-15a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25m19.5 0v.243a2.25 2.25 0 0 1-1.07 1.916l-7.5 4.615a2.25 2.25 0 0 1-2.36 0L3.32 8.91a2.25 2.25 0 0 1-1.07-1.916V6.75" /></svg>
                  <p>hello@gmail.com</p>
                </div>
              </div>
            </div>
        ...
        <div className="flex flex-row flex-nowrap justify-between gap-[clamp(0.25rem,1vw,3rem)] flex-[1.2] xl:max-w-xl xl:self-end pt-2 xl:pt-0 min-w-0">
          ...
          <div className="flex flex-col flex-1 min-w-0">
            ...
            <ul className="flex flex-col gap-1.5 font-dm-sans text-[clamp(7px,0.8vw,16px)] text-white/80">
