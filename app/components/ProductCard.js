...
export default function ProductCard({ product }) {
  ...
  return (
    <div className="group relative overflow-hidden transition-all duration-700 flex flex-col h-full">

      <div className="relative overflow-hidden aspect-[4/5] rounded-t-[40px] bg-black/[0.03]">
        ...
        <div className="absolute inset-x-4 bottom-4 translate-y-2 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500 z-10 hidden sm:flex flex-col gap-2">
          <button
            ...
            className="w-full py-3 bg-white/90 backdrop-blur-md text-black rounded-full font-sans text-[11px] font-bold tracking-[0.1em] uppercase hover:bg-black hover:text-white transition-all shadow-lg active:scale-95"
          >
            Add to Cart
          </button>
          <button
            onClick={handleWhatsAppBuyNow}
            className="w-full py-3 bg-brand-green text-white rounded-full font-sans text-[11px] font-bold tracking-[0.1em] uppercase hover:bg-opacity-90 transition-all shadow-lg active:scale-95 flex items-center justify-center gap-2"
          >
      ...
      <div className="p-5 flex flex-col items-center flex-1">
        ...
        <div className="flex justify-between items-center w-full px-1 mt-auto pt-5">
          <StarRating
