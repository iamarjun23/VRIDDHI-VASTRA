...
export default async function Contact() {
  ...
  return (
    <main className="bg-[#f3efe6] min-h-screen selection:bg-brand-green selection:text-white flex flex-col">
      ...
      {/* Hero Contact Section - Seamless Connection */}
      <section className="relative w-full min-h-screen flex items-center pt-[100px] pb-20 overflow-hidden">
        <div
          className="absolute inset-0 bg-cover bg-center bg-no-repeat z-0"
          style={{ backgroundImage: `url('${contactBg}')` }}
        ></div>

        {/* Grey Glass Overlay - Reduced Effect */}
        <div className="absolute inset-0 bg-[#3a403d]/10 backdrop-blur-[2px] z-0"></div>

        <div className="relative z-10 w-full max-w-[2000px] mx-auto px-[clamp(1.5rem,6vw,5rem)] flex flex-col lg:flex-row items-center justify-between gap-16">
          ...
          <div className="flex flex-col w-full lg:w-1/2 text-white">
            ...
            <h2 className="font-serif text-[clamp(2.5rem,8vw,5.5rem)] font-medium mb-8 leading-[1.1] drop-shadow-2xl">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-10 font-sans">
              <div className="flex flex-col gap-3 group cursor-pointer">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <p className="text-lg group-hover:text-brand-gold transition-colors">+91-9876543210</p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-3 group cursor-pointer">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <p className="text-lg transition-colors lowercase tracking-tight">Vriddhivastrasarees@gmail.com</p>
                </div>
              </div>
            </div>
          </div>
